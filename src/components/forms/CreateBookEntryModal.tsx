...
const CreateBookEntryModal: React.FC<CreateBookEntryModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  bookId,
                ...
                <DatePicker
                  ...
                  onChange={(newDate) => {
                    ...
                    if (newDate instanceof Date) {
                      dateValue = newDate;
                    } else if (newDate && typeof newDate === 'object' && 'toDate' in newDate) {
                      dateValue = (newDate as { toDate(): Date }).toDate();
                    } else {
                      dateValue = new Date();
                    }
...
export default CreateBookEntryModal;
