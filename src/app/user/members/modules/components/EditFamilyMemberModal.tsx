...
import { RelationshipType, CareLevel, FamilyMember, CreateFamilyMember } from "@/types/family-profile-type";

interface EditFamilyMemberModalProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (memberId: string, memberData: Partial<CreateFamilyMember>) => void;
